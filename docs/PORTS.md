...
| `0.0.0.0:8880` | ntfy | Published directly (not yet behind NPM) so Seerr/Diun notifications reach phones over Tailscale/LAN; see `stacks/media/README.md` |
| `0.0.0.0:8222` | Vaultwarden | Also reachable via `vault.home.saiprasad.io` through NPM |
